...
execute align xyz run summon area_effect_cloud ~.5 ~ ~.5 {Tags:[acv_portal,acv_inside],Duration:2147483647}
execute positioned ^ ^-1 ^ align xyz run summon area_effect_cloud ~.5 ~ ~.5 {Tags:[acv_portal,acv_inside,acv_corner],Duration:2147483647}
