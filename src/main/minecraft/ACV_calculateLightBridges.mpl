# Description: Summons an idle Lightbridge at every ASwT-ACV_CLB_PARAM named ACV_PortalIn, effectively sumonning it at the other one
...
/execute @e[name=ACV_PortalIn,tag=ACV_CLB_PARAM,score_ACV_COLOR_min=2,score_ACV_COLOR=3] ~ ~ ~ /execute @e[name=ACV_LightBridgeEnd,tag=!ACV_PurpleRed,r=0] ~ ~ ~ /summon ArmorStand ~ ~ ~ {CustomName:"ACV_LightBridge_WIP",Tags:["ACV_PurpleRed"],NoGravity:1b,Invisible:1b,Invulnerable:1b,Marker:1b}
/execute @e[name=ACV_PortalIn,tag=ACV_CLB_PARAM,score_ACV_COLOR_min=2,score_ACV_COLOR=3] ~ ~ ~ /execute @e[name=ACV_LightBridgeEnd,tag=!ACV_PurpleRed,r=0] ~ ~ ~ /summon ArmorStand ~ ~ ~ {CustomName:"ACV_AntiBridge_WIP",NoGravity:1b,Invisible:1b,Invulnerable:1b,Marker:1b}

/execute @e[name=ACV_LightBridgeEnd,tag=ACV_BlueOrange] ~ ~ ~ /scoreboard players tag @e[name=ACV_LightBridge_WIP,r=0] add ACV_BlueOrange
