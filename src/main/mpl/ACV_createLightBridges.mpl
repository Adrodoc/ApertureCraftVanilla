...
if: /testfor @e[type=armor_stand,name=ACV_PortalIn,score_ACV_COLOR_min=0,score_ACV_COLOR=0]
then { // only create light- and anti-bridge if the connection is open
  if: /testfor @e[type=armor_stand,name=ACV_PortalIn,score_ACV_COLOR_min=1,score_ACV_COLOR=1]
  then {
...
if: /testfor @e[type=armor_stand,name=ACV_PortalIn,score_ACV_COLOR_min=2,score_ACV_COLOR=2]
then { // only create light- and anti-bridge if the connection is open
  if: /testfor @e[type=armor_stand,name=ACV_PortalIn,score_ACV_COLOR_min=3,score_ACV_COLOR=3]
  then {
