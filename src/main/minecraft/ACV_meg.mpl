...
/execute @e[type=Creeper,name=ACV_MEG] ~ ~ ~ /kill @e[name=Weighted_Storage_Cube,r=0]
...
/execute @e[name=ACV_MEG] ~ ~ ~ /scoreboard players tag @a[r=0] add ACV_megDeletePortal_PARAM
conditional: /setblock ${1} redstone_block
