...
execute if entity @s[tag=acv_west] align xyz run summon area_effect_cloud ~.5 ~-.9375 ~.5 {CustomName:"\"acv_portal_out\"",Tags:[acv_uncolored],Rotation:[-90f,0f],Duration:2147483647}
