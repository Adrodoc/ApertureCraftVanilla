...
/execute @e[name=ACV_BridgeCross] ~ ~ ~ /scoreboard players tag @e[type=ArmorStand,name=ACV_AntiBridge,r=0] add ACV_KeepCarpet
/execute @e[name=ACV_BridgeBelow] ~ ~-1 ~ /scoreboard players tag @e[type=ArmorStand,name=ACV_AntiBridge,r=0] add ACV_Keep36
/execute @e[type=ArmorStand,name=ACV_AntiBridge] ~ ~ ~ /kill @e[name=ACV_BridgeCross,r=0,c=1]
/execute @e[type=ArmorStand,name=ACV_AntiBridge,tag=!ACV_KeepCarpet] ~ ~ ~ /kill @e[name=ACV_BridgeBelow,r=0]
/execute @e[type=ArmorStand,name=ACV_AntiBridge,tag=!ACV_KeepCarpet] ~ ~1 ~ /kill @e[name=ACV_BridgeBelow,r=0]
