...
/execute @e[type=ArmorStand,name=ACV_LightBridge] ~ ~ ~ detect ~ ~ ~ minecraft:carpet 3 /scoreboard players tag @e[type=ArmorStand,name=ACV_LightBridge,r=0,c=1] add ACV_InAir
/execute @e[type=ArmorStand,name=ACV_LightBridge] ~ ~ ~ detect ~ ~ ~ minecraft:piston_extension 0 /execute @e[r=0,c=1] ~ ~ ~ detect ~ ~1 ~ minecraft:carpet 3 /scoreboard players tag @e[type=ArmorStand,name=ACV_LightBridge,r=0,c=1] add ACV_InAir
/execute @e[type=ArmorStand,name=ACV_LightBridge,tag=!ACV_InAir] ~ ~ ~ /scoreboard players tag @e[name=ACV_PortalIn,r=0] add ACV_CLB_PARAM
