...
execute store result score @s acv_tmp run data get entity @e[tag=acv_portal,tag=acv_outside,scores={acv_portal_id=0},limit=1] Rotation[0] .011111111111111111
function acv:force/reset
execute if score @s acv_tmp matches 0 run scoreboard players operation @s acv_force_z = @s acv_motion_y
execute if score @s acv_tmp matches 0 run scoreboard players operation @s acv_force_z *= -1 acv_constant
execute if score @s acv_tmp matches 1 run scoreboard players operation @s acv_force_x = @s acv_motion_y
execute if score @s acv_tmp matches 2 run scoreboard players operation @s acv_force_z = @s acv_motion_y
execute if score @s acv_tmp matches 3 run scoreboard players operation @s acv_force_x = @s acv_motion_y
execute if score @s acv_tmp matches 3 run scoreboard players operation @s acv_force_x *= -1 acv_constant
scoreboard players operation @s acv_delta += @s acv_tmp
