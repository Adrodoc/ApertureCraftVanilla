...
/execute @e[name=ACV_BridgeCross] ~ ~ ~ scoreboard players tag @e[type=ArmorStand,name=ACV_AntiBridge,dy=0] add ACV_KeepCarpet
/execute @e[name=ACV_BridgeBelow] ~ ~-1 ~ scoreboard players tag @e[type=ArmorStand,name=ACV_AntiBridge,dy=0] add ACV_Keep36
